...
- In Media Remote, pair from the BLE information screen, use the advertise/reconnect action when disconnected, cancel advertising from the same control, tap large media controls once connected, press BtnA for previous track, and press BtnB for next track.
