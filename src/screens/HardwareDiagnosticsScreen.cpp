...
void HardwareDiagnosticsScreen::activateSelected(uint32_t nowMs) {
  ...
  switch (page_) {
    ...
    case Page::StatusLight:
      if (selected_ == 5) testStatusLightColor(0, 48, 0);
...
const char* HardwareDiagnosticsScreen::rowLabel(size_t index) const {
  ...
  switch (page_) {
    ...
    case Page::StatusLight: {
      constexpr const char* labels[] = {"", "Status", "Controller", "Control", "Color/Bright", "Test on", "Turn off", ""};
      return labels[index];
    }
  }
  return "";
  ...
  switch (page_) {
    ...
    case Page::Bluetooth:
      switch (index) {
        ...
        case 5:
          ...
          return bluetooth_.connected() ? bluetooth_.lastCommandName() : "Disconnected";
    ...
    case Page::StatusLight:
      switch (index) {
        ...
        case 4:
          return String(statusLight_.colorText()) + " / " + statusLight_.brightnessText();
