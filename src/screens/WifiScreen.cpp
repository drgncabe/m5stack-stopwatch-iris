...
void WifiScreen::enter() { lastDrawMs_ = 0; }
...
void WifiScreen::draw() {
  ...
  M5.Display.fillRoundRect(55, 302, 170, 58, 16, 0x2104);
  M5.Display.fillRoundRect(241, 302, 170, 58, 16, 0x2104);
  M5.Display.setFont(&fonts::FreeSans9pt7b);
  ...
  M5.Display.fillRoundRect(138, 378, 190, 48, 16, 0x2104);
